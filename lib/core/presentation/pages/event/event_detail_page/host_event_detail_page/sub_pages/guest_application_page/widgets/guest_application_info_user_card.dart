...
import 'package:app/core/presentation/pages/event/event_detail_page/host_event_detail_page/sub_pages/guest_application_page/widgets/guest_application_info_user_avatar.dart';
...
class GuestApplicationInfoUserCard extends StatelessWidget {
  final User? userInfo;
  const GuestApplicationInfoUserCard({
    super.key,
    this.userInfo,
  });
        ...
        children: [
          IntrinsicHeight(
            child: Row(
              ...
              children: [
                Flexible(
                  child: GuestApplicationInfoUserAvatar(
