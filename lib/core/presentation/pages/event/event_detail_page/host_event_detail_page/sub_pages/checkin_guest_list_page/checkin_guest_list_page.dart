...
@RoutePage()
class CheckInGuestListPage extends StatefulWidget {
  final EventGuestsTabs? initialTab;

  const CheckInGuestListPage({
    super.key,
    this.initialTab,
  });

  @override
  State<CheckInGuestListPage> createState() => _CheckInGuestListPageState();
}
...
class _CheckInGuestListPageState extends State<CheckInGuestListPage>
