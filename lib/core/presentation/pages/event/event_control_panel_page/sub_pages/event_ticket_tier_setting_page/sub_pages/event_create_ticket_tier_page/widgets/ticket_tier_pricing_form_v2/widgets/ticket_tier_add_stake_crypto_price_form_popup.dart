...
class TicketTierAddStakeCryptoPriceFormPopup extends StatelessWidget {
  final List<PaymentAccount> eventLevelStakePaymentAccounts;
  final TicketPriceInput? initialTicketPrice;
  const TicketTierAddStakeCryptoPriceFormPopup({
    super.key,
    required this.eventLevelStakePaymentAccounts,
...
class _ViewState extends State<_View> {
  ...
  void initState() {
    super.initState();
    availablePaymentAccounts = widget.eventLevelStakePaymentAccounts;
  ...
  Widget build(BuildContext context) {
    ...
    return GetChainsListBuilder(
      builder: (context, allChains) {
        final chains =
            allChains.where((c) => c.stakePaymentContract != null).toList();
