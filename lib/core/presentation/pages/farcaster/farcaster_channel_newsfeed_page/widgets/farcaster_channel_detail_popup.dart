...
class FarcasterChannelDetailPopup extends StatefulWidget {
  final FarcasterChannel channel;
  const FarcasterChannelDetailPopup({super.key, required this.channel});

  @override
  State<FarcasterChannelDetailPopup> createState() =>
      _FarcasterChannelDetailPopupState();
}

class _FarcasterChannelDetailPopupState
    extends State<FarcasterChannelDetailPopup> {
