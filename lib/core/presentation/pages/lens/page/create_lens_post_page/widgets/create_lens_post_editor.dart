...
class CreateLensPostEditor extends StatefulWidget {
  final Function(bool visible)? onSuggestionVisibleChanged;
  final Function(String message)? onContentChanged;

  const CreateLensPostEditor({
    super.key,
  ...
  @override
  State<CreateLensPostEditor> createState() => CreateLensPostEditorState();
}

class CreateLensPostEditorState extends State<CreateLensPostEditor> {
  ...
  Widget build(BuildContext context) {
    ...
    return FlutterMentions(
      ...
      onChanged: (message) {
        widget.onContentChanged?.call(message);
      },
    );
  }
}
