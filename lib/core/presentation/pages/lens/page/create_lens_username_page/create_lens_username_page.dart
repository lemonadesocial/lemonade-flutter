...
@RoutePage()
class CreateLensUsernamePage extends StatelessWidget {
  const CreateLensUsernamePage({super.key});
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: const CreateLensUsernamePageView(),
    );
  }
}

class CreateLensUsernamePageView extends StatefulWidget {
  const CreateLensUsernamePageView({
    super.key,
  });

  @override
  State<CreateLensUsernamePageView> createState() =>
      _CreateLensUsernamePageViewState();
}

class _CreateLensUsernamePageViewState
    extends State<CreateLensUsernamePageView> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<CreateLensUsernameBloc, CreateLensUsernameState>(
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            Text(
                              "Pick Lemonade Username",
                              style: appText.xl,
                            ),
                            SizedBox(height: Spacing.extraSmall),
                            Text(
                              "Secure your identity before someone else does. Price depends on character count. This cannot be changed later.",
