...
class GuildListItem extends StatelessWidget {
  final GuildBasic guildBasic;
  final Function() onTap;
  final bool? completed;
  final String? actionLabel;
  const GuildListItem({
    super.key,
    required this.guildBasic,
    required this.onTap,
    this.completed,
    this.actionLabel,
  });
              ...
              guildBasic.imageUrl != null
                  ? Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          guildBasic.imageUrl!.startsWith('https://')
                              ? Image.network(
                                  guildBasic.imageUrl ?? '',
                                  errorBuilder: (
