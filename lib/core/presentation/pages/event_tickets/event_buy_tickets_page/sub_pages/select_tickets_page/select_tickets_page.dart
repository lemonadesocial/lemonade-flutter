...
class SelectTicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<GetEventListTicketTypesResponseBloc,
        GetEventListTicketTypesResponseState>(
      listener: (context, state) {
        state.maybeWhen(
          orElse: () => null,
          success: (response) => context.read<SelectEventTicketTypesBloc>().add(
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              ...
              const Spacer(),
              BlocBuilder<SelectEventTicketTypesBloc,
                ...
                builder: (context, state) => Padding(
                  ...
                  child: SizedBox(
                    height: Sizing.large,
                    child: Opacity(
                      opacity: state.isSelectionValid ? 1 : 0.5,
