...
class EditorMobileToolbar extends StatefulWidget {
  const EditorMobileToolbar({
    super.key,
  ...
  @override
  State<EditorMobileToolbar> createState() => _EditorMobileToolbarState();
}

class _EditorMobileToolbarState extends State<EditorMobileToolbar> {
