...
_$_GetPostsInput _$$_GetPostsInputFromJson(Map<String, dynamic> json) =>
    _$_GetPostsInput(
      input: json['input'] == null
          ? null
          : FilterPostsInput.fromJson(json['input'] as Map<String, dynamic>),
...
_$_FilterPostsInput _$$_FilterPostsInputFromJson(Map<String, dynamic> json) =>
    _$_FilterPostsInput(
...
Map<String, dynamic> _$$_FilterPostsInputToJson(_$_FilterPostsInput instance) {
  final val = <String, dynamic>{};
