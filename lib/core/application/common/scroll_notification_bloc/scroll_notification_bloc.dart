...
class ScrollNotificationEvent with _$ScrollNotificationEvent {
  const factory ScrollNotificationEvent.scroll() = ScrollNotificationEventScroll;
  const factory ScrollNotificationEvent.reachEnd() = ScrollNotificationEventReachEnd;
}

@freezed
class ScrollNotificationState with _$ScrollNotificationState {
  const factory ScrollNotificationState.initial() = ScrollNotificationStateInitial;
  const factory ScrollNotificationState.endReached() = ScrollNotificationStateEndReached;
}