...
import 'package:app/utils/matrix_sdk_extensions/matrix_file_extension.dart';
import '../widgets/matrix.dart';

const Duration animationDurationDefault = Duration(milliseconds: 250);
...
class MxcImage extends StatefulWidget {
  ...
  const MxcImage({
    ...
    this.animationCurve = animationCurveDefault,
