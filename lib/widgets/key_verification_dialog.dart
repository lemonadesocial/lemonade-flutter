...
import 'package:app/utils/adaptive_bottom_sheet.dart';
...
class KeyVerificationPageState extends State<KeyVerificationDialog> {
  ...
  Future<void> checkInput(String input) async {
    ...
    if (valid.error != null) {
      await showOkAlertDialog(
        ...
        context: context,
        message: t.matrix.incorrectPassphraseOrKey,
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    var title = Text(t.matrix.verifyTitle);
    Widget body;
    ...
    switch (widget.request.state) {
            ...
            children: <Widget>[
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: t.matrix.passphraseOrKey,
      ...
      case KeyVerificationState.askAccept:
        title = Text(t.matrix.newVerificationRequest);
        body = Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              t.matrix.askVerificationRequest(username: displayName)
            )
          ],
        );
        buttons.add(
        ...
        body = Center(
          child: Column(
            children: <Widget>[
              ...
              const SizedBox(height: 16),
              Text(
                t.matrix.waitingPartnerAcceptRequest,
      ...
      case KeyVerificationState.askSas:
        ...
        if (widget.request.sasTypes.contains('emoji')) {
          ...
          title = Text(t.matrix.compareNumbersMatch);
        ...
        buttons.add(
          TextButton.icon(
            ...
            label: Text(t.matrix.theyDontMatch),
      ...
      case KeyVerificationState.waitingSas:
        final acceptText = widget.request.sasTypes.contains('emoji')
            ? t.matrix.waitingPartnerEmoji
            : t.matrix.waitingPartnerNumbers;
        body = Column(
          mainAxisSize: MainAxisSize.min,
          children: <Widget>[
