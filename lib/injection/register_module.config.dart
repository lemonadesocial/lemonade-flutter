...
import 'package:app/core/application/auth/auth_bloc.dart' as _i27;
import 'package:app/core/data/event/repository/event_repository_impl.dart'
    as _i8;
import 'package:app/core/data/poap/poap_repository_impl.dart' as _i15;
import 'package:app/core/data/post/newsfeed_repository_impl.dart' as _i13;
import 'package:app/core/data/post/post_repository_impl.dart' as _i17;
import 'package:app/core/data/token/token_repository_impl.dart' as _i20;
import 'package:app/core/data/user/user_repository_impl.dart' as _i22;
import 'package:app/core/data/wallet/wallet_repository_impl.dart' as _i26;
...
import 'package:app/core/domain/poap/poap_repository.dart' as _i14;
import 'package:app/core/domain/post/post_repository.dart' as _i16;
import 'package:app/core/domain/token/token_repository.dart' as _i19;
import 'package:app/core/domain/user/user_repository.dart' as _i21;
import 'package:app/core/domain/wallet/wallet_repository.dart' as _i25;
...
import 'package:app/core/service/shake/shake_service.dart' as _i18;
import 'package:app/core/service/user/user_service.dart' as _i23;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i14.PoapRepository>(() => _i15.PoapRepositoryImpl());
    gh.lazySingleton<_i16.PostRepository>(() => _i17.PostRepositoryImpl());
    gh.lazySingleton<_i18.ShakeService>(() => _i18.ShakeService());
    ...
    gh.lazySingleton<_i24.WalletConnectService>(
        () => _i24.WalletConnectService());
    gh.lazySingleton<_i3.WalletGQL>(() => _i3.WalletGQL());
    gh.lazySingleton<_i25.WalletRepository>(() => _i26.WalletRepositoryImpl());
