...
import 'package:app/core/application/auth/auth_bloc.dart' as _i19;
import 'package:app/core/data/event/repository/event_repository_impl.dart'
    as _i7;
import 'package:app/core/data/post/post_repository_impl.dart' as _i10;
import 'package:app/core/data/token/token_repository_impl.dart' as _i12;
import 'package:app/core/data/user/user_repository_impl.dart' as _i14;
import 'package:app/core/data/wallet/wallet_repository_impl.dart' as _i18;
import 'package:app/core/domain/event/event_repository.dart' as _i6;
import 'package:app/core/domain/post/post_repository.dart' as _i9;
import 'package:app/core/domain/token/token_repository.dart' as _i11;
import 'package:app/core/domain/user/user_repository.dart' as _i13;
import 'package:app/core/domain/wallet/wallet_repository.dart' as _i17;
...
import 'package:app/core/service/user/user_service.dart' as _i15;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.TokenRepository>(() => _i12.TokenRepositoryImpl());
    gh.lazySingleton<_i13.UserRepository>(() => _i14.UserRepositoryImpl());
    gh.lazySingleton<_i15.UserService>(() => _i15.UserService());
    gh.lazySingleton<_i16.WalletConnectService>(
        () => _i16.WalletConnectService());
    gh.lazySingleton<_i17.WalletRepository>(() => _i18.WalletRepositoryImpl());
