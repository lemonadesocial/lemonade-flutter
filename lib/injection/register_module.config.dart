...
import 'package:app/core/application/auth/auth_bloc.dart' as _i18;
...
import 'package:app/core/data/wallet/wallet_repository_impl.dart' as _i17;
...
import 'package:app/core/domain/wallet/wallet_repository.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i15.WalletConnectService>(
        () => _i15.WalletConnectService());
    gh.lazySingleton<_i16.WalletRepository>(() => _i17.WalletRepositoryImpl());
    gh.lazySingleton<_i18.AuthBloc>(() => _i18.AuthBloc(
