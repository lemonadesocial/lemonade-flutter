...
import 'package:app/core/data/notification/repository/notification_repository_impl.dart'
    as _i28;
import 'package:app/core/data/payment/payment_repository_impl.dart' as _i31;
import 'package:app/core/data/poap/poap_repository_impl.dart' as _i33;
import 'package:app/core/data/post/newsfeed_repository_impl.dart' as _i26;
import 'package:app/core/data/post/post_repository_impl.dart' as _i35;
...
import 'package:app/core/domain/notification/notification_repository.dart'
    as _i27;
import 'package:app/core/domain/payment/payment_repository.dart' as _i30;
import 'package:app/core/domain/poap/poap_repository.dart' as _i32;
import 'package:app/core/domain/post/post_repository.dart' as _i34;
...
import 'package:app/core/service/shake/shake_service.dart' as _i38;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i29.OwnerKeysDatabase>(() => _i29.OwnerKeysDatabase());
    gh.lazySingleton<_i30.PaymentRepository>(
        () => _i31.PaymentRepositoryImpl());
    gh.lazySingleton<_i32.PoapRepository>(() => _i33.PoapRepositoryImpl());
    gh.lazySingleton<_i34.PostRepository>(() => _i35.PostRepositoryImpl());
    gh.lazySingleton<_i36.ReportRepository>(() => _i37.ReportRepositoryImpl());
    gh.lazySingleton<_i38.ShakeService>(() => _i38.ShakeService());
    gh.lazySingleton<_i39.ShorebirdCodePushService>(
