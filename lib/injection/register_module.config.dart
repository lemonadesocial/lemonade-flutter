...
import 'package:app/core/application/auth/auth_bloc.dart' as _i39;
...
import 'package:app/core/data/event/repository/event_ticket_repository_impl.dart'
    as _i16;
import 'package:app/core/data/poap/poap_repository_impl.dart' as _i24;
import 'package:app/core/data/post/newsfeed_repository_impl.dart' as _i22;
import 'package:app/core/data/post/post_repository_impl.dart' as _i26;
import 'package:app/core/data/report/repository/report_repository_impl.dart'
    as _i28;
import 'package:app/core/data/token/token_repository_impl.dart' as _i32;
import 'package:app/core/data/user/user_repository_impl.dart' as _i34;
import 'package:app/core/data/wallet/wallet_repository_impl.dart' as _i38;
...
import 'package:app/core/domain/poap/poap_repository.dart' as _i23;
import 'package:app/core/domain/post/post_repository.dart' as _i25;
import 'package:app/core/domain/report/report_repository.dart' as _i27;
import 'package:app/core/domain/token/token_repository.dart' as _i31;
import 'package:app/core/domain/user/user_repository.dart' as _i33;
import 'package:app/core/domain/wallet/wallet_repository.dart' as _i37;
...
import 'package:app/core/service/shake/shake_service.dart' as _i29;
import 'package:app/core/service/shorebird_codepush_service.dart' as _i30;
import 'package:app/core/service/user/user_service.dart' as _i35;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i23.PoapRepository>(() => _i24.PoapRepositoryImpl());
    gh.lazySingleton<_i25.PostRepository>(() => _i26.PostRepositoryImpl());
    gh.lazySingleton<_i27.ReportRepository>(() => _i28.ReportRepositoryImpl());
    gh.lazySingleton<_i29.ShakeService>(() => _i29.ShakeService());
    gh.lazySingleton<_i30.ShorebirdCodePushService>(
        () => _i30.ShorebirdCodePushService());
    gh.lazySingleton<_i31.TokenRepository>(() => _i32.TokenRepositoryImpl());
    gh.lazySingleton<_i33.UserRepository>(() => _i34.UserRepositoryImpl());
    gh.lazySingleton<_i35.UserService>(() => _i35.UserService());
    gh.lazySingleton<_i36.WalletConnectService>(
        () => _i36.WalletConnectService());
    gh.lazySingleton<_i3.WalletGQL>(() => _i3.WalletGQL());
    gh.lazySingleton<_i37.WalletRepository>(() => _i38.WalletRepositoryImpl());
    gh.lazySingleton<_i39.AuthBloc>(() => _i39.AuthBloc(
