...
import 'package:app/core/data/report/repository/report_repository_impl.dart'
    as _i55;
import 'package:app/core/data/token/token_repository_impl.dart' as _i59;
import 'package:app/core/data/user/user_repository_impl.dart' as _i61;
import 'package:app/core/data/vault/vault_repository_impl.dart' as _i63;
import 'package:app/core/data/wallet/wallet_repository_impl.dart' as _i66;
import 'package:app/core/data/web3/web3_repository_impl.dart' as _i68;
...
import 'package:app/core/domain/token/token_repository.dart' as _i58;
import 'package:app/core/domain/user/user_repository.dart' as _i60;
import 'package:app/core/domain/vault/vault_repository.dart' as _i62;
import 'package:app/core/domain/wallet/wallet_repository.dart' as _i65;
import 'package:app/core/domain/web3/web3_repository.dart' as _i67;
...
import 'package:app/core/service/shake/shake_service.dart' as _i56;
import 'package:app/core/service/shorebird_codepush_service.dart' as _i57;
import 'package:app/core/service/vault/owner_key/database/owner_keys_database.dart'
    as _i45;
import 'package:app/core/service/wallet/wallet_connect_service.dart' as _i64;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i56.ShakeService>(() => _i56.ShakeService());
    gh.lazySingleton<_i57.ShorebirdCodePushService>(
        () => _i57.ShorebirdCodePushService());
    gh.lazySingleton<_i58.TokenRepository>(() => _i59.TokenRepositoryImpl());
    gh.lazySingleton<_i60.UserRepository>(() => _i61.UserRepositoryImpl());
    gh.lazySingleton<_i62.VaultRepository>(() => _i63.VaultRepositoryImpl());
    gh.lazySingleton<_i64.WalletConnectService>(
        () => _i64.WalletConnectService());
    gh.lazySingleton<_i3.WalletGQL>(() => _i3.WalletGQL());
    gh.lazySingleton<_i65.WalletRepository>(() => _i66.WalletRepositoryImpl());
    gh.lazySingleton<_i67.Web3Repository>(() => _i68.Web3RepositoryIml());
    return this;
  }
}
