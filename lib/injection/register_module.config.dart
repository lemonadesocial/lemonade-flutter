...
import 'package:app/core/application/auth/auth_bloc.dart' as _i21;
...
import 'package:app/core/data/token/token_repository_impl.dart' as _i14;
import 'package:app/core/data/user/user_repository_impl.dart' as _i16;
import 'package:app/core/data/wallet/wallet_repository_impl.dart' as _i20;
...
import 'package:app/core/domain/token/token_repository.dart' as _i13;
import 'package:app/core/domain/user/user_repository.dart' as _i15;
import 'package:app/core/domain/wallet/wallet_repository.dart' as _i19;
...
import 'package:app/core/service/shake/shake_service.dart' as _i12;
import 'package:app/core/service/user/user_service.dart' as _i17;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i12.ShakeService>(() => _i12.ShakeService());
    gh.lazySingleton<_i13.TokenRepository>(() => _i14.TokenRepositoryImpl());
    gh.lazySingleton<_i15.UserRepository>(() => _i16.UserRepositoryImpl());
    gh.lazySingleton<_i17.UserService>(() => _i17.UserService());
    gh.lazySingleton<_i18.WalletConnectService>(
        () => _i18.WalletConnectService());
    gh.lazySingleton<_i19.WalletRepository>(() => _i20.WalletRepositoryImpl());
