...
/// Strings: 210
///
/// Built on 2023-09-12 at 08:39 UTC
...
enum AppLocale with BaseAppLocale<AppLocale, _I18nEn> {
  ...
  @override
  final TranslationBuilder<AppLocale, _I18nEn> build;
...
class Translations {
  ...
  static _I18nEn of(BuildContext context) =>
      InheritedLocaleData.of<AppLocale, _I18nEn>(context).translations;
}
...
class TranslationProvider extends BaseTranslationProvider<AppLocale, _I18nEn> {
  ...
  static InheritedLocaleData<AppLocale, _I18nEn> of(BuildContext context) =>
      InheritedLocaleData.of<AppLocale, _I18nEn>(context);
}
...
class _I18nEn implements BaseTranslations<AppLocale, _I18nEn> {
  ...
  @override
  final TranslationMetadata<AppLocale, _I18nEn> $meta;
...
class _I18nDiscoverEn {
  ...
  late final _I18nDiscoverCardSectionsEn cardSections =
      _I18nDiscoverCardSectionsEn._(_root);
...
class _I18nChatEn {
  ...
  String unread_chats({required Object unreadCount}) =>
      '${unreadCount} unread chats';
  late final _I18nChatCommandEn command = _I18nChatCommandEn._(_root);
  String get typeMessage => 'type a message...';
  String get editMessage => 'Edit message';
  String dateAndTimeOfDay({required Object date, required Object timeOfDay}) =>
      '${date}, ${timeOfDay}';
  String dateWithoutYear({required Object month, required Object day}) =>
      '${month}-${day}';
  String dateWithYear(
          {required Object year, required Object month, required Object day}) =>
      '${year}-${month}-${day}';
  String get currentlyActive => 'Currently active';
  String get lastSeenLongTimeAgo => 'Seen a long time ago';
  String lastActiveAgo({required Object localizedTimeShort}) =>
      'Last active: ${localizedTimeShort}';
  String countParticipants({required Object count}) => '${count} participants';
  String numUsersTyping({required Object count}) =>
      '${count} users are typing...';
  String userIsTyping({required Object username}) => '${username} is typing...';
  String userAndUserAreTyping(
          {required Object username, required Object username2}) =>
      '${username} and ${username2} is typing';
  String userAndOthersAreTyping(
          {required Object username, required Object count}) =>
...
class _I18nNftEn {
  ...
  String get needLocationToClaimPoap =>
      'We need to access your location to check eligibility...';
  String get ineligibleToClaimPoap =>
      'Uh oh! 🙁 You are ineligible to claim this badge...';
  String get ableToClaimPoap =>
      'Congrats! 🥳 You meet all requirements to claim this badge';
...
class _I18nAuthEn {
  ...
  String get get_started_description =>
      'Sign up or log in to create, collaborate & celebrate! #makelemonade';
...
class _I18nCommonEn {
  ...
  String follower({required num n}) =>
      (_root.$meta.ordinalResolver ?? PluralResolvers.ordinal('en'))(
        n,
        one: 'follower',
        other: 'followers',
      );
  String friends({required num n}) =>
      (_root.$meta.ordinalResolver ?? PluralResolvers.ordinal('en'))(
        n,
        one: 'follower',
        other: 'followers',
      );
  String ticket({required num n}) =>
      (_root.$meta.ordinalResolver ?? PluralResolvers.ordinal('en'))(
        n,
        one: 'ticket',
        other: 'tickets',
...
class _I18nEventEn {
  ...
  String empty_attending_events({required Object time}) =>
      'You are currently not attending any events ${time}';
  ...
  String rsvpSuccessful({required Object eventName}) =>
...
class _I18nOnboardingEn {
  ...
  String get pickUsernameDesc =>
      'Claim your unique username before someone else does!';
  ...
  String get findYourLookDesc =>
      'Show off your personality and creativity through your profile photo or an NFT';
  String get aboutYou => 'About you';
  String get aboutYouDesc => 'Announce yourself to the world!';
  String get interest => 'Interests';
  String get interestDesc =>
...
class _I18nDiscoverCardSectionsEn {
  ...
  // Translations
  late final _I18nDiscoverCardSectionsEventsEn events =
      _I18nDiscoverCardSectionsEventsEn._(_root);
  late final _I18nDiscoverCardSectionsCollaboratorsEn collaborators =
      _I18nDiscoverCardSectionsCollaboratorsEn._(_root);
  late final _I18nDiscoverCardSectionsBadgesEn badges =
      _I18nDiscoverCardSectionsBadgesEn._(_root);
  late final _I18nDiscoverCardSectionsMusicEn music =
      _I18nDiscoverCardSectionsMusicEn._(_root);
}
...
class _I18nNftPoapPolicyEn {
  ...
  // Translations
  late final _I18nNftPoapPolicyEventPolicyEn eventPolicy =
      _I18nNftPoapPolicyEventPolicyEn._(_root);
  late final _I18nNftPoapPolicyEmailPolicyEn emailPolicy =
      _I18nNftPoapPolicyEmailPolicyEn._(_root);
  late final _I18nNftPoapPolicyPhonePolicyEn phonePolicy =
      _I18nNftPoapPolicyPhonePolicyEn._(_root);
  late final _I18nNftPoapPolicyLocationPolicyEn locationPolicy =
      _I18nNftPoapPolicyLocationPolicyEn._(_root);
  late final _I18nNftPoapPolicyTwitterPolicyEn twitterPolicy =
      _I18nNftPoapPolicyTwitterPolicyEn._(_root);
  late final _I18nNftPoapPolicyUserPolicyEn userPolicy =
      _I18nNftPoapPolicyUserPolicyEn._(_root);
}
...
extension on _I18nEn {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      case 'home.newsfeed':
        return 'Newsfeed';
      case 'home.whatOnYourMind':
        return 'What\'s on your mind, Joseph?';
      case 'discover.discover':
        return 'Discover';
      case 'discover.cardSections.events.title':
        return 'Events';
      case 'discover.cardSections.events.subTitle':
        return 'Find unique experiences';
      case 'discover.cardSections.collaborators.title':
        return 'Collaborators';
      case 'discover.cardSections.collaborators.subTitle':
        return 'Connect & create with others';
      case 'discover.cardSections.badges.title':
        return 'Badges';
      case 'discover.cardSections.badges.subTitle':
        return 'Exclusive rewards near you';
      case 'discover.cardSections.music.title':
        return 'Vinyls';
      case 'discover.cardSections.music.subTitle':
        return 'Music that you truly own';
      case 'discover.hotBadgesNearYou':
        return 'Hot badges near you';
      case 'discover.upcomingEvents':
      ...
      case 'post.follower':
        return 'Followers';
      case 'post.selectEvent':
        return 'Select event';
      case 'post.searchEventHint':
        return 'search for events or their hosts';
      case 'chat.unread':
        return 'unread';
      case 'chat.channels':
        return 'channels';
      case 'chat.directMessages':
        return 'direct messages';
      case 'chat.spaces':
        return 'spaces';
      case 'chat.home':
        return 'home';
      case 'chat.unread_chats':
        return ({required Object unreadCount}) => '${unreadCount} unread chats';
      case 'chat.command.ban':
        return 'Ban the given user from this room';
      case 'chat.command.clearcache':
        return 'Clear cache';
      case 'chat.command.create':
        return 'Create';
      case 'chat.command.discardsession':
        return 'Discard session';
      case 'chat.command.dm':
        return 'Start a direct chat\nUse --no-encryption to disable encryption';
      case 'chat.command.html':
        return 'Send HTML-formatted text';
      case 'chat.command.invite':
        return 'Invite the given user to this room';
      case 'chat.command.join':
        return 'Join the given room';
      case 'chat.command.kick':
        return 'Remove the given user from this room';
      case 'chat.command.leave':
        return 'Leave this room';
      case 'chat.command.me':
        return 'Describe yourself';
      case 'chat.command.myroomavatar':
        return 'Set your picture for this room (by mxc-uri)';
      case 'chat.command.myroomnick':
        return 'Set your display name for this room';
      case 'chat.command.op':
        return 'Set the given user\'s power level (default: 50)';
      case 'chat.command.plain':
        return 'Send unformatted text';
      case 'chat.command.react':
        return 'Send reply as a reaction';
      case 'chat.command.send':
        return 'Send text';
      case 'chat.command.unban':
        return 'Unban the given user from this room';
      case 'chat.command.markasdm':
        return 'Mark as direct message room';
      case 'chat.command.markasgroup':
        return 'Mark as group';
      case 'chat.command.googly':
        return 'Send some googly eyes';
      case 'chat.command.hug':
        return 'Send a hug';
      case 'chat.command.cuddle':
        return 'Send a cuddle';
      case 'chat.typeMessage':
        return 'type a message...';
      case 'chat.editMessage':
        return 'Edit message';
      case 'chat.dateAndTimeOfDay':
        return ({required Object date, required Object timeOfDay}) =>
            '${date}, ${timeOfDay}';
      case 'chat.dateWithoutYear':
        return ({required Object month, required Object day}) =>
            '${month}-${day}';
      case 'chat.dateWithYear':
        return (
                {required Object year,
                required Object month,
                required Object day}) =>
            '${year}-${month}-${day}';
      case 'chat.currentlyActive':
        return 'Currently active';
      case 'chat.lastSeenLongTimeAgo':
        return 'Seen a long time ago';
      case 'chat.lastActiveAgo':
        return ({required Object localizedTimeShort}) =>
            'Last active: ${localizedTimeShort}';
      case 'chat.countParticipants':
        return ({required Object count}) => '${count} participants';
      case 'chat.numUsersTyping':
        return ({required Object count}) => '${count} users are typing...';
      case 'chat.userIsTyping':
        return ({required Object username}) => '${username} is typing...';
      case 'chat.userAndUserAreTyping':
        return ({required Object username, required Object username2}) =>
            '${username} and ${username2} is typing';
      case 'chat.userAndOthersAreTyping':
        return ({required Object username, required Object count}) =>
            '${username} and ${count} others are typing...';
      case 'chat.isTyping':
        return 'is typing...';
      case 'chat.emptyChat':
        return 'Empty chat';
      case 'chat.youAreInvitedToThisChat':
        return 'You are invited to this chat';
      case 'nft.onSale':
        return 'on sale';
      case 'nft.created':
        return 'created';
      ...
      case 'nft.sold':
        return 'sold';
      case 'nft.emptyCreatedNfts':
        return 'You have not created any NFTs yet';
      case 'nft.noCollectible':
        return 'No collectibles yet';
      case 'nft.claimed':
        return 'claimed';
      case 'nft.claim':
        return 'claim';
      case 'nft.claiming':
        return 'claiming';
      case 'nft.needLocationToClaimPoap':
        return 'We need to access your location to check eligibility...';
      case 'nft.ineligibleToClaimPoap':
        return 'Uh oh! 🙁 You are ineligible to claim this badge...';
      case 'nft.ableToClaimPoap':
        return 'Congrats! 🥳 You meet all requirements to claim this badge';
      case 'nft.badges':
        return 'badges';
      case 'nft.noBadges':
        return 'No badges found';
      case 'nft.poapPolicy.eventPolicy.title':
        return ({required Object event}) => 'RSVP to ${event}';
      case 'nft.poapPolicy.eventPolicy.qualified':
        return '';
      case 'nft.poapPolicy.eventPolicy.nonQualified':
        return 'not RSVP\'d to the event';
      case 'nft.poapPolicy.emailPolicy.title':
        return 'Verify email address';
      case 'nft.poapPolicy.emailPolicy.qualified':
        return 'Completed';
      case 'nft.poapPolicy.emailPolicy.nonQualified':
        return 'Incomplete';
      case 'nft.poapPolicy.phonePolicy.title':
        return 'Verify phone number';
      case 'nft.poapPolicy.phonePolicy.qualified':
        return 'Completed';
      case 'nft.poapPolicy.phonePolicy.nonQualified':
        return 'Incomplete';
      case 'nft.poapPolicy.locationPolicy.title':
        return 'Location';
      case 'nft.poapPolicy.locationPolicy.qualified':
        return 'Completed';
      case 'nft.poapPolicy.locationPolicy.nonQualified':
        return 'Incomplete';
      case 'nft.poapPolicy.twitterPolicy.title':
        return ({required Object twitter}) => 'Follow @${twitter} on Twitter';
      case 'nft.poapPolicy.twitterPolicy.qualified':
        return 'Completed';
      case 'nft.poapPolicy.twitterPolicy.nonQualified':
        return 'Incomplete';
      case 'nft.poapPolicy.twitterPolicy.error':
        return 'account not connected';
      case 'nft.poapPolicy.userPolicy.title':
        return ({required Object username}) =>
            'Follow @${username} on Lemonade';
      case 'nft.poapPolicy.userPolicy.qualified':
      ...
      case 'auth.logout':
        return 'Logout';
      case 'auth.lets_get_you_in':
        return 'Let\'s get you in!';
      case 'auth.get_started_description':
        return 'Sign up or log in to create, collaborate & celebrate! #makelemonade';
      case 'auth.get_started':
        return 'Get Started';
      case 'notification.notifications':
        return 'Notifications';
      case 'notification.emptyNotifications':
        return 'No notifications yet';
      case 'common.today':
        return 'today';
      case 'common.tomorrow':
        return 'tomorrow';
      case 'common.thisWeek':
        return 'this week';
      case 'common.thisWeekend':
        return 'this weekend';
      case 'common.nextWeek':
        return 'next week';
      case 'common.nextWeekend':
        return 'next weekend';
      case 'common.nextMonth':
        return 'next month';
      case 'common.somethingWrong':
        return 'There\'s something wrong';
      case 'common.following':
        return 'following';
      case 'common.description':
        return 'description';
      case 'common.joinedOn':
        return ({required Object date}) => 'joined on ${date}';
      ...
      case 'common.actions.connect':
        return 'connect';
      case 'common.actions.editProfile':
        return 'Edit profile';
      case 'common.actions.shareProfile':
        return 'Share profile';
      case 'common.actions.follow':
        return 'Follow';
      case 'common.actions.cancel':
        return 'Cancel';
      case 'common.actions.goToSettings':
        return 'Go to settings';
      case 'common.followed':
        return 'Followed';
      case 'common.anonymous':
        return 'anonymous';
      case 'common.profileUrlCopied':
        return 'Profile\'s URL copied to clipboard';
      case 'common.upcoming':
        return 'Upcoming';
      case 'common.past':
        return 'Past';
      case 'common.noPhotos':
      ...
      case 'common.search':
        return 'search';
      case 'common.viewRequirements':
        return 'view requirements';
      case 'common.grantAccess':
        return 'grant access';
      case 'common.nearMe':
        return 'Near me';
      case 'common.maximumDistance':
        return 'Maximum distance';
      case 'common.community':
        return 'community';
      ...
      case 'event.empty_attending_events':
        return ({required Object time}) =>
            'You are currently not attending any events ${time}';
      case 'event.empty_hosting_events':
        return ({required Object time}) =>
            'You are currently not hosting any events ${time}';
      case 'event.noEvents':
      ...
      case 'event.youreIn':
        return 'You\'re in! 🎉';
      case 'event.rsvpSuccessful':
        return ({required Object eventName}) =>
            'Congrats! You have successfully RSVP’d to ${eventName}.';
      case 'event.takeMeToEvent':
      ...
      case 'onboarding.pickUsernameDesc':
        return 'Claim your unique username before someone else does!';
      ...
      case 'onboarding.next':
        return 'Next';
      case 'onboarding.displayName':
        return 'Display name';
      case 'onboarding.shortBio':
        return 'Short bio';
      case 'onboarding.she':
        return 'she';
      case 'onboarding.he':
        return 'he';
      case 'onboarding.they':
        return 'they';
      case 'onboarding.skip':
        return 'Skip';
      case 'onboarding.findYourLook':
        return 'Find your look';
      case 'onboarding.findYourLookDesc':
        return 'Show off your personality and creativity through your profile photo or an NFT';
      case 'onboarding.aboutYou':
        return 'About you';
      case 'onboarding.aboutYouDesc':
        return 'Announce yourself to the world!';
      case 'onboarding.interest':
        return 'Interests';
      case 'onboarding.interestDesc':
        return 'Pick what you are passionate about & unlock a world of tailored content';
      case 'onboarding.usernameAvailable':
