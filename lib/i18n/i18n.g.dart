...
class _I18nEventEn {
	...
	String rsvpSuccessful({required Object eventName}) => 'Congrats! You have successfully RSVP’d to ${eventName}.';
...
extension on _I18nEn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'event.youreIn': return 'You\'re in! 🎉';
			case 'event.rsvpSuccessful': return ({required Object eventName}) => 'Congrats! You have successfully RSVP’d to ${eventName}.';
			case 'event.takeMeToEvent': return 'Take me to the event';
			case 'event.inviteFriends': return 'Invite friends';
